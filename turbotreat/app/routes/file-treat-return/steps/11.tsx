...
export default function Step11() {
  ...
  const [hasSiblings, setHasSiblings] = useState(treatReturnState.step11.hasSiblings);
  const [siblings, setSiblings] = useState<Sibling[]>(treatReturnState.step11.siblings || []);
  const [newSiblingName, setNewSiblingName] = useState(treatReturnState.step11.newSiblingName || "");
  const [newSiblingCostume, setNewSiblingCostume] = useState(treatReturnState.step11.newSiblingCostume || "");
